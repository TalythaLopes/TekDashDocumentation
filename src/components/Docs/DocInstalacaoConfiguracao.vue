<template>
  ...
  <p>
    ...
    compatibilidade total com o TekDashboard. Caso seu sistema esteja desatualizado, <bold>realize a atualização antes </bold> de
    continuar.
  </p>
  <h5 class="LStyleDocumentation">2. Liberação do Módulo</h5>
  <p>
    Solicite a <bold>liberação do módulo TekDashboard</bold> ao nosso setor comercial. Assim que confirmarmos a liberação, o
    recurso ficará disponível na sua licença.
  </p>
  ...
  <p>
    ...
    <bold>porta configurada está aberta e acessível</bold>. Recomenda-se o udo de um
  ...
  <p>
    Após configurar o TekServer, é importante garantir que <bold>cada usuário tenha permissão</bold> para acessar o módulo. Para
    isso, basta acessar o <bold>gerenciamento de usuários do próprio ERP</bold> e conceder acesso ao
    <bold> módulo 36</bold> referente ao TekDashboard, conforme a imagem abaixo.
  </p>
  <img
    class="LStyleDocumentation"
  ...
  <p>
    ...
    <bold>o TekDashboard segue rigorosamente o controle de acesso do ERP.</bold> Se o usuário <bold>não tem permissão</bold> no
    ERP, ele também <bold>não terá acesso</bold> no TekDashboard.
  </p>
  ...
  <p>
    O processo segue <bold>o mesmo padrão de qualquer agendamento</bold> no ERP: criar um arquivo .bat e associá-lo ao Agendador
    de Tarefas do Windows. A estrutura básica é:
  </p>
  <CodeBlock>
  ...
  <p>
    ...
    aplicação TekDashboard. Deve-se <bold>configurar esses parâmetros</bold> dentro da própria aplicação <bold>antes</bold> de
    iniciar os envios.
  </p>
</template>
