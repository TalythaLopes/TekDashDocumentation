<template>
  ...
  <p>
    Nossa plataforma funciona como uma ferramenta de visualização de dados ("dashboards") para empresas que utilizam
    nosso sistema ERP. É importante entender que a autenticação, o controle de acesso e a gestão dos dados são
  ...
  <p>
    ...
    <bold>Controlador de Dados:</bold> A empresa que você representa, que contratou os serviços da <bold>
      Tek-System Informática LTDA</bold> e utiliza o ERP, é a <bold>Controladora</bold> dos seus dados
    pessoais.<br />
    <v-icon>mdi-circle-small</v-icon>
    <bold>Operador de Dados:</bold> A <bold>Tek-System Informática LTDA</bold>, como fornecedora da plataforma
  ...
  <p>
    <v-icon>mdi-circle-small</v-icon>Não se envolver em atividades que sejam ilegais ou contrárias à boa-fé e à
    ordem pública.<br />
    <v-icon>mdi-circle-small</v-icon>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica,
    pornográfica, de apologia ao terrorismo
    ou que atente contra os direitos humanos.<br />
